...
%demander à Delphine et co qu'est-ce qui constitue leur pain quotidien ?
...
%\item de repérer et quantifier les réarrangements entre nos librairies et la référence 
...
%On choisit de reporter les alignements alternatifs dans le tag XA pour tous les reads qui ont 10 best hits au plus. Ces positions alternatives nous permettront de prendre en compte d'éventuels transferts de gènes entre génomes. 
...
%Ensuite, le filtrage. On utilise les alignements réalisés précédemment. Comme on veut en priorité assembler la mitochondrie, on écarte tous les reads qui ont un best hit unique sur le noyau ou le chloroplaste.
...
%La normalisation digitale est une technique qui utilise la distribution de l'abondance des k-mers pour estimer la couverture par read et éliminer les reads dont la couverture dépasse la limite imposée.\cite{brown2012reference} Elle présente l'avantage, outre de réduire la taille du jeu de données, d'homogéiniser les couvertures des deux génomes.
...
%Nous avons testé deux outils de normalisation digitale, la suite khmer et le script Perl intégré à l'assembleur Trinity.

%Pour comparer l'efficacité des différentes procédures, on aligne les jeux de données réduits contre la référence et on estime à nouveau les couvertures. Nous pouvons envisager d'assembler les jeux de données suffisamment réduits.
...
%La figure \ref{schemachloro} représente les 3 régions du chloroplaste, les deux régions uniques en rouge et en vert et la région répétée en bleu. Les arcs de cercle noirs symbolisent les jonctions entre ces régions. ``
...
%Nous avons tenté de déterminer la nature des reads non mappés pour Cvi-0 en effectuant des BLASTs mais l'alignement local était beaucoup trop lent. Nous avons donc essayé l'approche inverse en constituant une banque de séquence avec les reads non mappés et en blastant le génome entier d'\textit{Arabidopsis Thaliana} contre cette banque. Des séquences d'\textit{Arabidopsis} ne se sont alignées que sur 10 000 des 60 000 séquences de la banque. Nous avons donc regardé la composition en base....

%\textit{après analyse des reads non mappés, on trouve qu'ils comportent beaucoup de SNP (plus de 7SNP par 50 base). Ce sont des régions génomiques qui diffèrent entre les accessions et des microsats }

%pour de nombreuses séquences, la distance avec la référence est plus elevé que celles autorisées
%d'autres séquences sont très répétées
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{Assemblage/couvavantapres.pdf}
\label{norm}
\caption{La couverture le long de la mitochondrie de référence pour Cvi-0 avant et après normalisation à 30X avec khmer}
\end{figure}

On a aligné le jeux de données à la référence (sans chromosome 2) avant et après normalisation. Avant normalisation, on constate que la couverture le long de la mitochondrie varie entre 30 et 90X. Les pics vers le bas correspondent à des régions de la mitochondrie présentes également sur le noyau. Les reads correspondant à ces régions sont majoritairement mitochondriaux mais vont se répartir aléatoirement entre le noyau et la mitochondrie (choix aléatoire d'un best hit parmi plusieurs lors de l'alignement), ce qui diminue artificiellement la couverture de la mitochondrie à ces endroits et gonfle celle du noyau. C'est pour cette raison qu'on a masqué le chromosome 2 de la référence pour cette alignement. Ce chromosome présente de très grandes nombreuses insertions mitochondriales et déstabilise complètement la couverture le long de la mitochondrie si on ne le masque pas. 

Après normalisation, la couverture le long de la mitochondrie varie beaucoup moins. Elle est centrée autour de 40X. On constate l'apparence de nouveaux pics vers le bas. Ils correspondraient à des régions de la mitochondrie commune avec le chloroplaste. Les k-mer communs à la mitochondrie et au chloroplaste ont vus leur abondance réduite par khmer à 40X en tout ; ils recouvrent donc en moyenne 20X la mitochondrie et 20X le chloroplaste d'où les chutes ponctuelles de couverture.  \\
\end{comment}
...
\begin{tabular}{|l|cc||cc||cc|}
  \hline
 & \multicolumn{2}{c||}{Avant} & \multicolumn{2}{c||}{Normalisation avec khmer} & \multicolumn{2}{c|}{Normalisation avec Trinity} \\
 \hline
 & Chloroplaste & Mitochondrie & Chloroplaste & Mitochondrie & Chloroplaste & Mitochondrie \\ 
  \hline
Cvi-0 & 545.38 & 35.48 & 60.69 & 36.20 & 46.29 & 32.66 \\
Sha & 2661.22 & 1198.36 & 71.92 & 48.90 & 51.87 & 35.82 \\
   \hline
\end{tabular}
\caption{Les couvertures par accessions avant et après normalisation}
\end{table}
...
\begin{tabular}{|l|cc||cc||cc|}
  \hline
 & \multicolumn{2}{c||}{Avant} & \multicolumn{2}{c||}{Après ré-échantillonage} & \multicolumn{2}{c|}{Après filtration} \\
 \hline
 & Chloroplaste & Mitochondrie & Chloroplaste & Mitochondrie & Chloroplaste & Mitochondrie \\ 
  \hline
Cvi-0 & 545.38 & 35.48 & 191.78 & 13.38 & 185.20 & 21.58 \\
Sha & 2661.22 & 1198.36 & 285.48 & 133.46 & 995.49 & 747.82 \\ 
   \hline
\end{tabular}
\caption{Les couvertures par accessions avant et après réduction des données par filtrage ou ré-échantillonage}
\end{table}
