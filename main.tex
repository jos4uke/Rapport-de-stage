...
\newcommand{\hladd}[2]{\hl{#1} \add{#2}}
\newcommand{\hlremove}[2]{\hl{#1} \remove{#2}}
\newcommand{\hlrewrite}[2]{\hl{#1} \rewrite{#2}}
\newcommand{\hlcomment}[2]{\hl{#1} \todo{#2}}
%%
...
\begin{enumerate}
	\item l'étude des \hlrewrite{variantes}{variations} \add{génomiques et} génétiques mitochondrial et chloroplastique pour les 8 accessions naturelles
