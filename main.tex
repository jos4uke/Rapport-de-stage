...
\subfloat[Graphe de ressemblance entre le chloroplaste de référence (en abscisse) et les contigs obtenus (en ordonnée)]{
 ...
 \subfloat[Graphe de ressemblance entre la mitochondrie de référence en abscisse et les contigs obtenus (pour MetaVelvet, hash length 71, \protect\detokenize{exp_covs 300_32, cov_cutoff 5}) en ordonnée]{
